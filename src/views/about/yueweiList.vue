    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="detailDialogVisible" width="900px">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px;margin-left:50px;">
        ...
        <div v-else>
          ...
          <el-form-item v-if="dataForm.category==='文化理念'" label="中文名称" prop="name">
            <el-input v-model="dataForm.name"/>
          </el-form-item>
          <el-form-item v-else label="名称" prop="name">
            <el-input v-model="dataForm.name"/>
          </el-form-item>
          <el-form-item v-if="dataForm.category==='文化理念'" label="英文名称" prop="title">
          ...
          <el-form-item v-if="dataForm.category === '关于悦为'" label="关于悦为定义" style="width: 700px">
            <editor :init="editorInit" v-model="dataForm.content"/>
          </el-form-item>
          <el-form-item v-if="dataForm.category === '文化理念'" label="文化理念介绍" style="width: 700px">
            <editor :init="editorInit" v-model="dataForm.content"/>
          </el-form-item>
        </div>
      </el-form>
