<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.name" clearable class="filter-item" style="width: 200px;" placeholder="请输入岗位名称"/>
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" min-width="" label="岗位名称" prop="name"/>
      ...
      <el-table-column align="center" label="中文标题" prop="title"/>

      <el-table-column align="center" label="英文标题" prop="content"/>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="detailDialogVisible" width="900px">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="英文标题" prop="content">
...
<script>
import { list, Delete, create, update } from '@/api/join'
