<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.isOnDisplay" style="width: 200px" class="filter-item" placeholder="请选择状态" clearable="true">
        <el-option v-for="(key, value) in isOnDisplayMap" :key="key" :label="key" :value="value"/>
      </el-select>
      <el-select v-model="listQuery.category" style="width: 200px" class="filter-item" placeholder="请选择分类" clearable="true">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="detailDialogVisible" width="900px">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px;margin-left:50px;">
        ...
        <div v-else>
          ...
          <el-form-item v-if="dataForm.category == 'Banner图片' || dataForm.category == '客服服务案例' || dataForm.category == '合作流程' || dataForm.category == '客服服务'" label="图片" prop="picUrl">
            <el-upload
              :headers="headers"
              :action="uploadPath"
          ...
          <el-form-item label="分类" prop="category">
            <el-select v-model="dataForm.category" disabled style="width: 300px" class="filter-item" placeholder="分类">
              <el-option v-for="(key, value) in categoryMap" :key="key" :label="key" :value="value"/>
            </el-select>
          </el-form-item>
          ...
          <el-form-item v-if="dataForm.category === '客服服务' || dataForm.category === '客服服务现状' || dataForm.category === '悦为优势'" label="内容" style="width: 700px">
...
<script>
import { list, Delete, create, update } from '@/api/operate/customer'
