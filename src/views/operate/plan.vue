    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="detailDialogVisible" width="900px">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px;margin-left:50px;">
        ...
        <div v-else>
          ...
          <el-form-item v-if="dataForm.category == 'Banner图片' || dataForm.category == '创造高转化率，打造爆款产品' || dataForm.category == '品牌策划案例' || dataForm.category == '合作流程'" label="图片" prop="picUrl">
            <el-upload
              :headers="headers"
              :action="uploadPath"
          ...
          <el-form-item v-if="dataForm.category === '品牌策划' || dataForm.category === '创造高转化率，打造爆款产品' || dataForm.category === '品牌策划优势'" label="内容" style="width: 700px">
...
<script>
import { list, Delete, create, update } from '@/api/operate/plan'
