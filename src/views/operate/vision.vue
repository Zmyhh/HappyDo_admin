    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="detailDialogVisible" width="900px">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px;margin-left:50px;">
        ...
        <div v-else>
          ...
          <el-form-item v-if="dataForm.category == 'Banner图片' || dataForm.category == '品牌视觉' || dataForm.category == '品牌视觉案例' || dataForm.category == '合作流程'" label="图片" prop="picUrl">
            <el-upload
              :headers="headers"
              :action="uploadPath"
          ...
          <el-form-item v-if="dataForm.category === '品牌视觉' || dataForm.category === '品牌视觉痛点' || dataForm.category === '视觉优势'" label="内容" style="width: 700px">
...
<script>
import { list, Delete, create, update } from '@/api/operate/vision'
