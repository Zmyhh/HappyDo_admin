    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="detailDialogVisible" width="900px">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px;margin-left:50px;">
        ...
        <div v-else>
          ...
          <el-form-item v-if="dataForm.category == 'Banner图片' || dataForm.category == '爆款计划' || dataForm.category == '数据服务案例' || dataForm.category == '合作流程' || dataForm.category == '悦为优势' " label="图片" prop="picUrl">
            <el-upload
              :headers="headers"
              :action="uploadPath"
          ...
          <el-form-item v-if="dataForm.category === '爆款计划' || dataForm.category === '如何打造爆款' || dataForm.category === '悦为优势' " label="内容" style="width: 700px">
...
<script>
import { list, Delete, create, update } from '@/api/market/explosive'
